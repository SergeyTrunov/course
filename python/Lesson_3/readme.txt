...
"Легко заметить, что числа во втором,
  ...
  имеют вид 6n+2; 6n+3 и 6n+4  [и 6n ?]
...
хххххх хQQQхQ хQQQхQ хQQQхQ хQQQхQ хQQQхQ хQQQхQ хQQQхQ хQQQхQ
123 5  7   11 13  17 19  23 25  29 31  35 37  41 43  47 49  53
=======
...
Для упорядоченного списка придумайте эффективный метод поиска. 
...
map() применяет переданную функцию к каждому элементу 
в переданном списке (списках) и возвращает список результатов 
(той же размерности, что и входной);
